    ...
    <div class="content-wrapper">
        <div class="row grid-margin">
            <div class="col-lg-12">
              ...
              @endif
                  <form class="cmxform" id="commentForm" method="post" action="/sauverslider" enctype="multipart/form-data">
                    {{csrf_field()}}
                    <fieldset>
                      ...
                      <div class="form-group">
                        ...
                        <input id="cprice" class="form-control" type="text" name="description2">
                      </div>
                      <div class="form-group">
