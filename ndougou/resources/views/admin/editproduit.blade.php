              ...
              <div class="card">
                <div class="card-body">
                  <h4 class="card-title">Edit Produit</h4>
                        ...
                        @endif
                  <form class="cmxform" id="commentForm" method="post" enctype="multipart/form-data" action="/modifierproduit">
                    {{csrf_field()}}
                    <fieldset>
                        ...
                        <div class="form-group">
                            ...
                            <input id="cname" class="form-control" name="product_name" value="{{$product->product_name}}"  type="text">
                        </div>
                        <div class="form-group">
                            <label for="cprice">Prix</label>
                            <input id="cprice" class="form-control" type="number" value="{{$product->product_price}}" name="product_price">
                        </div>
